...
(function(){
  ...
  ms.textContent='.smilex-marker{position:absolute;z-index:9999;width:24px;height:24px;transform:translate(-50%,-50%);display:flex;align-items:center;justify-content:center;border-radius:50%;font-size:11px;font-weight:700;color:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.25);cursor:pointer;transition:transform .15s,box-shadow .15s;-webkit-user-select:none;user-select:none;font-family:-apple-system,BlinkMacSystemFont,sans-serif;line-height:1}.smilex-marker:hover{transform:translate(-50%,-50%) scale(1.25);box-shadow:0 4px 16px rgba(0,0,0,0.35)}.smilex-marker-active{outline:2px solid #fff}.smilex-target-highlight{outline-offset:3px;transition:outline-color .2s,background-color .2s}.smilex-placing-active{cursor:crosshair!important}.smilex-placing-active *{cursor:crosshair!important}.smilex-placing-highlight{outline:2px dashed #2563eb!important;outline-offset:2px;background-color:rgba(37,99,235,0.05)!important}';
  ...
  function renderMarkers(annotations,activePage,selectedId){
    ...
    document.querySelectorAll('.smilex-target-highlight').forEach(function(el){el.classList.remove('smilex-target-highlight');el.style.outline='';el.style.backgroundColor='';});
    ...
    Object.keys(byPage).forEach(function(pageId){
      ...
      byPage[pageId].forEach(function(a){
        ...
        var x=((targetRect.left-containerRect.left+targetRect.width/2)/containerRect.width)*100;
        var y=((targetRect.top-containerRect.top+targetRect.height/2)/containerRect.height)*100;
