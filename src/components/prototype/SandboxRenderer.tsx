...
(function(){
  ...
  window.addEventListener('message',function(e){
    ...
    if(e.data.type==='smilex-focus-annotation'){
      ...
      renderMarkers(_currentAnnotations,_currentActivePage,e.data.id||_currentSelectedId);
    }
  });
})();
</script>`
